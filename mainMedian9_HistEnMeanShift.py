...
#img.exportImage("C:\Users\milto\Downloads\cyprus2\clustering\Median9_HistEn.tif")
#centres = np.array(img.clusterWithKMeans(7,10,1)).astype(np.uint8)
centres = np.array(img.meanShiftClustering()).astype(np.uint8)
...
img.exportImage("C:\Users\milto\Downloads\cyprus2\clustering\Median9_HistEnMeanShifClusters.tif")
img.Laplacian()

img.exportImage("C:\Users\milto\Downloads\cyprus2\clustering\Median9_HistEnMeanShiftLines.tif")
